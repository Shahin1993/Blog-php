...
<?php
	 ...
	 $statement= $db->prepare("SELECT * FROM tbl_post WHERE cat_id=? ORDER BY p_id DESC");
	 ...
	 $statement= $db->prepare("SELECT * FROM tbl_post WHERE cat_id=? ORDER BY p_id DESC LIMIT $start, $limit");
		$statement->execute(array($id) );
	...
	?>
	  ...
	  <div class= "description">
		 ...
		 ?>
			 ...
			 <span>|</span> <a href= "index2.php?id=<?php echo $row["p_id"]; ?>">Continue Reading</a>
			 </p>
			 </div>
